...
## Description
Currently,the Nineinfra supports to manage the simple data warehouse with the projects include kyuubi,metastore,postgresql,
...
If you are a data processing novice or just want to experience the nineinfra, you only need one parameter to start and 
experience nineinfra. The follow yaml is an example,you just need to specify only one parameter to create a data warehouse.
...
```
If you want to use the nineinfra in depth, you can refer to the sample config/samples/ninecluster-custom.yaml 
to customize your own cloud-native data warehouse.
